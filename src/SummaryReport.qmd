...
This heatmap shows the prediction scores that was found using the FindTransferAnchors function in Seurat, displaying which of your unlabeled clusters have the highest similarity to the reference.
